...
const controller = testerlib.MDeprecatedPaymentsController;
...
describe("MDeprecatedPaymentsController Tests", function tests() {
...
<li><a href="https://baas-cdt.zendesk.com/hc/pt-br/articles/360030076971-Porque-%C3%A9-importante-o-uso-do-Validate-%C3%89-poss%C3%ADvel-pagar-boletos-vencidos-">Why is it important to use the /Validate? It is possible to pay due bank slip?</a></li>
     ...
     */
    it("should testMPaymentsAccountIdAccount response", function testMPaymentsAccountIdAccountTest(done) {
        // parameters for the API call
        let contentType = 'application/json';
        let authorization = '{{tokenOauth}}';

        controller.getPaymentsAccountIdAccount(contentType, authorization, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            // test headers
            let headers = [];
            ...
            assert.isTrue(TestHelper.isArrayOfJsonObjectsProperSubsetOf(context.response.body, [
  {
    ...
    "dueDate": "2018-11-15T12: 00: 00",
    "description": "SABESP"
  },
  {
    "id": 203,
    "idAdjustment": 310851926,
    "idIssuer": 73,
    "uniqueIdDablan": "cnCqg8Lk4+6APhS3H+68gQ==",
    "account": 10057584,
    "amount": "59.99",
    "barCode": "846100000005599900800013102845891344121841901105",
    "dueDate": "2018-11-15T12: 00: 00",
    "description": "VIVO SP"
  }
], false, true, false));
     ...
     */
    it("should testMPaymentsAdjustmentIdAdjustment response", function testMPaymentsAdjustmentIdAdjustmentTest(done) {
        // parameters for the API call
        let contentType = 'application/json';
        let authorization = '{{tokenOauth}}';

        controller.getPaymentsAdjustmentIdAdjustment(contentType, authorization, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            // test headers
            let headers = [];
