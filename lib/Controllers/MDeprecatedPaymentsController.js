...
class MDeprecatedPaymentsController {
    /**
     ...
     * @param {MPaymentsrequest} body TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createPayments(authorization, accept, contentType, body, callback) {
    ...
    /**
     * <p>Find a payment recipient by the idAccount</p>
     *
     * @param {string} contentType TODO: type description here
     * @param {string} authorization TODO: type description here
     *
     ...
     * @returns {Promise}
     */
    static getPaymentsAccountIdAccount(contentType, authorization, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _pathUrl = '/payments/account/10057584';
        const _queryBuilder = `${_baseUri}${_pathUrl}`;
            ...
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    parsed = parsed.map(model =>
                        _baseController.getObjectMapper().mapObject(model, 'MPaymentsAccountIdAccount'));
     ...
     * @returns {Promise}
     */
    static getPaymentsAdjustmentIdAdjustment(contentType, authorization, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _pathUrl = '/payments/adjustment/310851921';
        const _queryBuilder = `${_baseUri}${_pathUrl}`;
...
module.exports = MDeprecatedPaymentsController;
