...
/**
 * Creates an instance of MStatusCartoes
 */
class MStatusCartoes extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            { name: 'content', realName: 'content', array: true, type: 'Content8' },
