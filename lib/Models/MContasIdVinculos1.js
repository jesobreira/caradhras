...
/**
 * Creates an instance of MContasIdVinculos1
 */
class MContasIdVinculos1 extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            { name: 'content', realName: 'content', array: true, type: 'Content1' },
...
module.exports = MContasIdVinculos1;
