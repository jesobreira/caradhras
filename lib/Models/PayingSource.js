...
/**
 * Creates an instance of PayingSource
 */
class PayingSource extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.identityFederativeUnity = this.constructor.getValue(obj.identityFederativeUnity);
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'identityFederativeUnity', realName: 'identityFederativeUnity' },
