...
/**
 * Creates an instance of MPaymentsV1Scheduler
 */
class MPaymentsV1Scheduler extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'items', realName: 'items', array: true, type: 'Item2' },
        ]);
    }
...
module.exports = MPaymentsV1Scheduler;
