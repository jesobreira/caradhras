...
/**
 * Creates an instance of MContasIdVinculosTipos1
 */
class MContasIdVinculosTipos1 extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            { name: 'content', realName: 'content', array: true, type: 'Content2' },
...
module.exports = MContasIdVinculosTipos1;
