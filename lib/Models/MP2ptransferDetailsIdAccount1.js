...
/**
 * Creates an instance of MP2ptransferDetailsIdAccount1
 */
class MP2ptransferDetailsIdAccount1 extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.transactionUUID = this.constructor.getValue(obj.transactionUUID);
        ...
        this.cause = this.constructor.getValue(obj.cause);
        this.idAdjustmentDestination = this.constructor.getValue(obj.idAdjustmentDestination);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'cause', realName: 'cause' },
            { name: 'idAdjustmentDestination', realName: 'idAdjustmentDestination' },
        ]);
    }
...
module.exports = MP2ptransferDetailsIdAccount1;
